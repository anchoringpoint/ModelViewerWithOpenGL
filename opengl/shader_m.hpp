...
public:
    ...
    {
        this->setVec3(name + ".direction", dirLight.direction);
        this->setVec3(name + ".ambient", dirLight.ambient);
        this->setVec3(name + ".diffuse", dirLight.diffuse);
        this->setVec3(name + ".specular", dirLight.specular);
    }
    void setSpotLight(const std::string& name, const Camera& camera,const SpotLight& spotLight) const
    {
        this->setVec3(name + ".position", camera.Position);
        this->setVec3(name + ".direction", camera.Front);
        ...
        this->setFloat(name + ".cutOff", glm::cos(glm::radians(spotLight.cutOff)));
        this->setFloat(name + ".outerCutOff", glm::cos(glm::radians(spotLight.outerCutOff)));
    }
